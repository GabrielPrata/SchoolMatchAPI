    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> CheckIfEmailIsVerified(string userEmail)
        {
            try
            {
                ...
                {
                    return StatusCode(403, new ApiErrorModel("Esse e-mail ainda n�o foi verificado!", 403));
                }
